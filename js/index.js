...
console.log(result.toUpperCase().split("").join(" "));
...
// // let phraseToCheck = "Was it a car or a cat I saw?"; -> faux
// // ;
...
let phraseToCheck = "Was it a car or a cat I saw?"; //-> corrected by TA
